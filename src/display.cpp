    ...
    if (strlen(text) > 0) {
        ...
        do {
            if (index < 0) {
                ...
                display.drawUTF8(1, 29, "\x003A\x0033\x003A");
                display.drawUTF8(1, 61, "\x0033\x003A\x0033");
                display.drawUTF8(1, 93, "\x003A\x0033\x003A");
                display.drawUTF8(1, 125, "\x0033\x003A\x0033");
            }
            else {
                strncpy(display_text, &text[index], 1);
                display.setFont(u8g2_font_logisoso92_tn);
                display.drawUTF8(3, 110, display_text);	
            }
